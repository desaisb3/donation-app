...
public class MainActivity extends AppCompatActivity {
    ...
    //CREATING METHOD TO OPEN HOME PAGE OF THE APP WHEN THE USER Create the Account
    ...
    public void openRecipientMainScreen(String user_username){
        //PASS TO THE OTHER ACTIVITY THE INFORMATION ACCOUNT USERNAME
        Bundle BN = new Bundle();
