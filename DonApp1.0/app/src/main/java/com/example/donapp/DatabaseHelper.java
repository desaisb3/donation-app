...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void updateUserInfo(DatabaseHelper DOP,String newName, String newSurname, String newEmail){
        SQLiteDatabase SQ = DOP.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(COL_FIRST_NAME,newName);
        values.put(COL_LAST_NAME,newSurname);
        values.put(COL_EMAIL,newEmail);
        SQ.update(TABLE_NAME_2,values, null,null);
    }

    // retrive information from the database
    public Cursor getInformation(com.example.donapp.DatabaseHelper dop) {
        SQLiteDatabase SQ = dop.getReadableDatabase();
        String[] coloumns = {COL_FIRST_NAME,COL_LAST_NAME,COL_EMAIL};
        Cursor CR = SQ.query(TABLE_NAME_2,coloumns,null,null,null,null,null);
        return CR;
    }
/*
    public  void deleteAccount(String accountName){
        ...
        Log.d(TAG,"deleteName: " + accountName + "from database.");
        db.execSQL(query);
    }
