...
public class RecipientMainScreen extends AppCompatActivity {
    ...
    public static String AccountUserRecipient;
    @Override
    ...
    public Integer setID(){
        ...
        ID = B.getInt("ID_AccountRecipient");
        return ID;
    }

    public String setCurrentAccountUsername(){
        Bundle B = getIntent().getExtras();
        AccountUserRecipient = B.getString("RecipientAccountName");
        return AccountUserRecipient;
    }
